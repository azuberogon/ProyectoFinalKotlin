//[app](../../../index.md)/[com.example.dallyproject.imanol](../index.md)/[LocalDatabase](index.md)
...
Clase que representa la base de datos local de la aplicación. Esta clase utiliza RoomDatabase para definir la base de datos y proporcionar acceso a los DAOs correspondientes.

## Constructors

| | |
|---|---|
| [LocalDatabase](-local-database.md) | [androidJvm]<br>constructor() |
...
| Name | Summary |
|---|---|
| [actividadDao](actividad-dao.md) | [androidJvm]<br>abstract fun [actividadDao](actividad-dao.md)(): [ActividadDAO](../../[root]/-actividad-d-a-o/index.md) |
...
| [signUpDao](sign-up-dao.md) | [androidJvm]<br>abstract fun [signUpDao](sign-up-dao.md)(): [SignUpDAO](../-sign-up-d-a-o/index.md) |
| [tematicasDao](tematicas-dao.md) | [androidJvm]<br>abstract fun [tematicasDao](tematicas-dao.md)(): [TematicasDAO](../-tematicas-d-a-o/index.md) |
